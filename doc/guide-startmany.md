...
2. [Sending 10,000 Crypto Dezire Cash to new wallet addresses.](#option2)
...
### Send 10,000 Crypto Dezire Cash to New Addresses

Just like setting up a standard MN. Send exactly 10,000 Crypto Dezire Cash to each new address created above.
...
*Please note, the masternode priviate key is not the same as a wallet private key. Never put your wallet private key in the masternode.conf file. That is equivalent to putting your 10,000 Crypto Dezire Cash on the remote server and defeats the purpose of a hot/cold setup.*
