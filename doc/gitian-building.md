...
*Setup instructions for a gitian build of Crypto Dezire Cash using a Debian VM or physical system.*
...
to cryptodezirecash-crypto.com.
...
- [Building Crypto Dezire Cash](#building-cryptodezirecash)
...
Clone the git repositories for cryptodezirecash and gitian and then checkout the cryptodezirecash version that you want to build.

```bash
git clone https://github.com/devrandom/gitian-builder.git
git clone https://github.com/cryptodezirecash-crypto/cryptodezirecash.git
cd cryptodezirecash
...
Follow the instructions in [doc/release-process.md](release-process.md) in the cryptodezirecash repository
under 'Fetch and build inputs' to install sources which require manual intervention. Also follow
the next step: 'Seed the Gitian sources cache', which will fetch all necessary source files allowing
for gitian to work offline.

Building Crypto Dezire Cash
----------------

To build Crypto Dezire Cash (for Linux, OSX and Windows) just follow the steps under 'perform
gitian builds' in [doc/release-process.md](release-process.md) in the cryptodezirecash repository.
...
```bash
    Initialized empty Git repository in /home/debian/gitian-builder/inputs/cryptodezirecash/.git/
    remote: Reusing existing pack: 35606, done.
    remote: Total 35606 (delta 0), reused 0 (delta 0)
    Receiving objects: 100% (35606/35606), 26.52 MiB | 4.28 MiB/s, done.
    Resolving deltas: 100% (25724/25724), done.
    From https://github.com/cryptodezirecash-crypto/cryptodezirecash
...
For example:
```bash
URL=https://github.com/crowning-/cryptodezirecash.git
...
```bash
    gpg --detach-sign ${VERSION}-linux/${SIGNER}/cryptodezirecash-build.assert
    gpg --detach-sign ${VERSION}-win/${SIGNER}/cryptodezirecash-build.assert
    gpg --detach-sign ${VERSION}-osx/${SIGNER}/cryptodezirecash-build.assert
```
...
[cryptodezirecash/gitian.sigs](https://github.com/cryptodezirecash-crypto/gitian.sigs/) repository, or if that's not possible to create a pull
request.
