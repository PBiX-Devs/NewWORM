...
above instead of `libssl-dev`. WORM Core does not support the use of OpenSSL 1.1, though compilation is still possible
...
When the intention is to run only a P2P node without a wallet, WORM Core may be compiled in
