...
class TestNode():
    ...
    def __init__(self, i, dirname, extra_args, rpchost, timewait, binary, stderr, mocktime, coverage_dir, use_cli=False):
        ...
        if binary is None:
            self.binary = os.getenv("BITCOIND", "wormd")
        else:
            self.binary = binary
        self.stderr = stderr
        ...
        self.cli = TestNodeCLI(os.getenv("BITCOINCLI", "worm-cli"), self.datadir)
...
class TestNodeCLI():
    ...
    def __call__(self, *options, input=None):
        # TestNodeCLI is callable with worm-cli command-line options
