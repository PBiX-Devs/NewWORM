#!/usr/bin/env python3
# Copyright (c) 2019 The Crypto Dezire Cash Core developers
...
from fake_stake.base_test import Crypto Dezire Cash_FakeStakeTest
from time import sleep

class zPoSFakeStakeAccepted(Crypto Dezire Cash_FakeStakeTest):
    ...
    def set_test_params(self):
        ...
        self.num_nodes = 1
        self.extra_args = [['-staking=1', '-debug=net', '-zcdzcstake']] * self.num_nodes
