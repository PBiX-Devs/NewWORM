...
bool zWormControlWidgetItem::operator<(const QTreeWidgetItem &other) const {
...
void ZWormControlDialog::updateList()
{
    ...
    for (const CMintMeta& mint : setMints) {
        ...
        zWormControlWidgetItem *itemMint = new zWormControlWidgetItem(ui->treeWidget->topLevelItem(mapDenomPosition.at(denom)));
